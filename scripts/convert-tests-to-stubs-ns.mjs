...
for (const t of tests) {
  ...
  // use namespace import to support default and named exports
  const relImport = `./${base}`;
  const stub = `import * as Mod from '${relImport}';
...
console.log('Updated test stubs (namespace import):', updated);
process.exit(0);

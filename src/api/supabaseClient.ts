...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  logger.error('Supabase: faltan variables de entorno VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY');
  throw new Error('Supabase config: define VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY en .env.local');
}
...
export function subscribeAuthChanges(callback: (event: AuthChangeEvent, session: Session | null) => void) {

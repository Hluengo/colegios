...
export default function Dashboard() {
  ...
  return (
    <div className="container space-y-6 sm:space-y-8 px-1 sm:px-0">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
        {/* CASOS URGENTES */}
        <div className="xl:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm p-3 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={() => navigate('/casos-activos')}
                className="px-3 py-2 text-sm border border-slate-200 rounded hover:bg-brand-50 text-slate-700 w-full sm:w-auto tap-target"
              >
                Ver todos
              </button>
            </div>
          ...
          {topAlertas.length === 0 ? (
            ...
            <div className="space-y-3">
              {topAlertas.map((a) => {
                ...
                return (
                  <button
                    ...
                    disabled={disabled}
                    className={`w-full border rounded-lg p-2.5 sm:p-3 transition text-left ${
                      disabled
                    ...
                    aria-label={
                      disabled
                        ...
                        : `Abrir seguimiento de ${a.etapa_debido_proceso || 'etapa'}`
                    }
                  >
              ...
              <button
                ...
                className="text-sm text-red-600 hover:underline tap-target inline-flex items-center"
              >

...
export default function AlertasPlazos() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8 pb-8 px-1 sm:px-0">
      {/* HEADER */}
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 border-b border-slate-200 pb-6">
        <div>
...
function Seccion({
  ...
  return (
    <section
      className={`glass-panel p-4 sm:p-6 ${styles.wrapper_bg} border border-slate-200 shadow-glass`}
    >
        ...
        {items.map((s) => {
          ...
          return (
            <button
              ...
              disabled={disabled}
              className={`w-full border rounded-xl p-5 transition-all bg-white relative overflow-hidden group text-left
              ...
              aria-label={
                disabled
                  ? 'Alerta sin caso vinculado'
                  : `Abrir seguimiento de ${s.etapa_debido_proceso || 'etapa'}`
              }
            >
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-100 pl-2">
                ...
                <div className="flex flex-col items-end gap-0.5 min-w-0">
                  <span className="text-[10px] font-bold text-slate-700 truncate max-w-[120px] sm:max-w-[220px]">

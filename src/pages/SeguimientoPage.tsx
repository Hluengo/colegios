              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full flex justify-between items-center px-3 sm:px-4 py-3 bg-gradient-to-r from-brand-50/70 to-transparent text-left"
                  >
                  ...
                  {isOpen && (
                    <div className="px-4 pb-4 space-y-3">
                      ...
                      {!readOnly && (
                        <button
                          className="text-sm text-slate-700 hover:underline tap-target inline-flex items-center"

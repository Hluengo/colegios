...
import { Eye, EyeOff, MapPin, Phone, Mail, Building2, Star, Users, Shield, BarChart3 } from 'lucide-react'
...
export default function Login({ onLoginSuccess }: LoginProps) {
  ...
  useEffect(() => {
    const loadColegioDemo = async () => {
      try {
        ...
        console.log('No se pudo cargar colegio demo')
      } finally {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 text-white p-8 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-xl font-semibold">Plataforma de Convivencia Escolar</span>
          </div>
        </div>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="w-20 h-20 bg-white rounded-xl flex items-center justify-center overflow-hidden shadow-lg">
                  <img 
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = '/branding/generic_logo.png'
                    }}
                  />
                </div>
                <div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-8">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-800">Convivencia Escolar</h1>
          ...
          <div className="mt-6 p-4 bg-primary-50 rounded-lg text-sm border border-primary-100">
            <p className="font-medium text-primary-700 mb-2"> Cuenta demo disponible</p>
            <p className="text-primary-600">Solicita acceso de prueba para explorar todas las funcionalidades del sistema.</p>
            <a 

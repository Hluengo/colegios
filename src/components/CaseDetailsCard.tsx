  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white flex flex-col overflow-hidden shadow-sm">
      ...
      >
        ...
        <div className="absolute bottom-3 left-4 right-4 flex gap-2 flex-wrap justify-end">
          <span
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-xs text-gray-400 mt-2 flex items-center gap-2 flex-wrap">
                          ...
                          <button
                            ...
                            className="text-blue-600 hover:text-blue-800 font-semibold hover:underline tap-target inline-flex items-center"
                          >
                            📎 Ver evidencias
                          </button>
                          {/* Botón editar */}
                          {onEditAction && (
                            <>
                              ...
                              <button
                                ...
                                className="text-gray-600 hover:text-gray-800 font-semibold hover:underline tap-target inline-flex items-center"
                              >
                                ✏️ Editar
                              </button>
                            </>

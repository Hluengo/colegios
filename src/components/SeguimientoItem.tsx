                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="inline-flex items-center rounded-md px-2 py-1 text-blue-600 text-xs hover:bg-blue-50 hover:underline tap-target"
                    >
                      Ver
                    </button>
                    {!readOnly && (
                      <button
                        ...
                        className="inline-flex items-center rounded-md px-2 py-1 text-red-600 text-xs hover:bg-red-50 hover:underline disabled:opacity-50 tap-target"
                      >

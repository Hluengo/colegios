...
export function Avatar({
  ...
  return (
    ...
    >
      {showFallback ? (
        <span className={`${bgColor} text-white font-semibold flex items-center justify-center w-full h-full`}>
  ...
  return (
    <div className="flex items-center">
      {visibleAvatars.map((child, index) => (
        <div
          key={isValidElement(child) && child.key ? String(child.key) : `avatar-${index}`}
...
export function AvatarWithTooltip({ showTooltip = true, name, ...props }: AvatarWithTooltipProps) {
  return (

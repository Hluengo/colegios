...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        'bg-white text-surface-600 border border-surface-200 hover:bg-surface-50 hover:text-surface-900 focus:ring-surface-300',
      ghost:
        'text-surface-500 hover:bg-surface-100 hover:text-surface-900 focus:ring-surface-300',
      danger:

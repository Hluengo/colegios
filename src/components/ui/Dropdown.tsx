  ...
  return (
    <div ref={dropdownRef} className="relative inline-block max-w-full">
      ...
      <button
        ...
        className="cursor-pointer flex items-center gap-2 max-w-full"
        aria-haspopup="menu"
      ...
      {isOpen && !disabled && (
        <div
          className={`
            ...
            py-1 min-w-[min(11rem,calc(100vw-1rem))] max-w-[calc(100vw-1rem)]
            animate-scale-in
          `}
          style={{
      ...
      trigger={
        <div
          className={`
            ...
            transition-colors duration-200 min-w-0 w-full sm:min-w-[200px]
          `}
        >
          {selectedOption ? (
      ...
      {isOpen && (
        <div
          className={`
            ...
            bg-white rounded-xl border border-surface-200 shadow-surface-lg
            py-1 min-w-[min(12rem,calc(100vw-1rem))] max-w-[calc(100vw-1rem)]
            animate-scale-in
          `}
          role="menu"
        >

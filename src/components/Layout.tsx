...
export default function Layout() {
  ...
  // Android back button: close mobile drawer first.
  useEffect(() => {
    if (!isMobile || !mobileSidebarOpen) return;

    const state = { mobileSidebar: true, ts: Date.now() };
  ...
  return (
    <>
      ...
      <div className="flex min-h-[100dvh] overflow-hidden bg-slate-50 selection:bg-accent-500/30">

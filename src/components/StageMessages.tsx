    ...
    <div className="mt-4 rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden flex flex-col max-h-[520px]">
      ...
      {!readOnly && (
        <form
          ...
          className="border-t border-slate-100 bg-white p-4 space-y-3 sm:sticky sm:bottom-0"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-end">
            ...
            <button
              ...
              className="px-4 py-2 rounded-full bg-brand-600 text-white text-xs font-bold disabled:opacity-50 w-full sm:w-auto"
            >

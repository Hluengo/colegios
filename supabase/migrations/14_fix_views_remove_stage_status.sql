-- ============================================
-- 14_fix_views_remove_stage_status.sql
-- Re-crea vistas para no depender de case_followups.stage_status
-- ============================================

-- ============================================
-- Corregir v_control_plazos_plus
-- ============================================
...
SELECT 
  ...
  'Completada'::text AS estado_etapa, -- Ya no hay stage_status, cada followup es completada
...
-- ============================================
-- Corregir v_control_plazos_case_resumen
-- ============================================
CREATE OR REPLACE VIEW public.v_control_plazos_case_resumen AS
WITH resumen AS (
...
sin_plazo AS (
  ...
  WHERE c.seguimiento_started_at IS NOT NULL
    ...
    AND NOT EXISTS (
      SELECT 1 FROM v_control_plazos_plus v

-- =====================================================
-- 22_sync_backend_contract.sql
-- Alinea funciones helper y vista v_control_unificado
-- con el contrato que consume el frontend.
-- =====================================================
...
seguimiento AS (
  ...
  LEFT JOIN public.stage_sla ss ON ss.stage_key = lf.process_stage AND ss.tenant_id = c.tenant_id
...
SELECT 'OK: backend contract synchronized' AS status;
